...
public class ParamServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ParamServlet " + metodo + "</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Introduzca sus datos por ejemplo</h1>");
...
//                out.println("</form>");
//            }
//            // resultado que se muestra cuando es POST
//            if (metodo.equals("POST")) {
            out.println("<p>Te llamas " + request.getParameter("nombre")
                    + " y tienes " + request.getParameter("edad") + " años");
            //  }
